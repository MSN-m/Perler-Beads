...
import { flattenCandidateSource, generateCandidatePatternData } from './candidate-processor.js';
...
function renderPatternPreviewLayer() {
    ...
    setText('pattern-preview-summary', `候选算法 · ${getWorkbenchGenerationSummary()}`);
...
function buildPatternPreview(style = 'photo') {
    const sourceImageData = flattenCandidateSource(getSourceImageDataForGeneration());
    const result = generateCandidatePatternData({
        sourceImageData,
        gridWidth: AppState.gridWidth,
        gridHeight: AppState.gridHeight,
        brand: AppState.brand,
    ...
    AppState.patternPreviewPixelData = result.pixelData;
